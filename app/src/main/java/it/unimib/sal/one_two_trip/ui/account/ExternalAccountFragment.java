...
/**
 * Fragment that shows data of another user.
 */
public class ExternalAccountFragment extends Fragment implements RemoteStorageCallback {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_external_account, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.imagePath = this.application.getFilesDir() + "/" + this.id + "-" + PROFILE_PICTURE_NAME;
        ...
        this.userViewModel.getUser(this.id).observe(getViewLifecycleOwner(), result -> {
            if (result.isSuccess()) {
