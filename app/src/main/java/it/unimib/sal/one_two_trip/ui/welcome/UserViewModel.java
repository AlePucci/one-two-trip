...
public class UserViewModel extends ViewModel {
    ...
    public MutableLiveData<Result> changeEmail(String email) {
        MutableLiveData<Result> emailChangeMutableLiveData = this.userRepository.changeEmail(email);

        return emailChangeMutableLiveData;
    }
    ...
    public MutableLiveData<Result> deleteUser(){
        this.userMutableLiveData = this.userRepository.deleteUser();
